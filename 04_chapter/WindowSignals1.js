...
Elm.WindowSignals1.make = function (_elm) {
   ...
   var _op = {};
   var display = F3(function (_p0,w,h) {
      var _p1 = _p0;
      return A2($Graphics$Element.flow,
      $Graphics$Element.down,
      A2($List.map,
      function (_p2) {
         return $Graphics$Element.leftAligned($Text.fromString(_p2));
      },
      _U.list([A2($Basics._op["++"],"Window.dimensions.width: ",$Basics.toString(_p1._0))
              ,A2($Basics._op["++"],"Window.dimensions.height: ",$Basics.toString(_p1._1))
              ,A2($Basics._op["++"],"Window.width: ",$Basics.toString(w))
              ,A2($Basics._op["++"],"Window.height: ",$Basics.toString(h))])));
   });
   var main = A3($Signal.map2,
   F2(function (x,y) {    return y(x);}),
   $Window.height,
   A3($Signal.map2,F2(function (x,y) {    return y(x);}),$Window.width,A3($Basics.flip,$Signal.map,$Window.dimensions,display)));
   return _elm.WindowSignals1.values = {_op: _op,display: display,main: main};
};
